...
import { createListing, getListing, deleteListing, updateListing, getOneListing, getContactLandLord, getListings } from '../controllers/listing.controller.js'
...
listingRouter.route('/getListings').get(getListings)
