...
const UpdateListing = () => {
    ...
    const userRef = currentUser?.result?._id
    ...
    // localhost:5000/api/v1/listing/getOneListing/659a9caa91ce120216f71ce8 url
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const { data } = await axios({
                method: 'put',
                url: `/api/v1/listing/updateListing/${listingId}`,
                headers: {
